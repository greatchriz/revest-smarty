            ...
            <div class="row">
              <div class="col-sm-6">
                  <div class="input input--secondary">
                      ...
                      <input type="text" name="fullname" id="fullName" placeholder="Full Name" value='{$frm.fullname|escape:"quotes"}' required="required" />
                  </div>
              </div>
              <div class="col-sm-6">
                  <div class="input input--secondary">
                      <label for="userName">User Name*</label>
                      <input type="text" name="username" id="userName" placeholder="User Name" value='{$frm.username|escape:"quotes"}' required="required" />
                  </div>
              </div>
          </div>
